...
import com.xlentdevs.spectrum.databinding.ListItemMessageReceivedBinding
import com.xlentdevs.spectrum.databinding.ListItemMessageSentBinding
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return when (viewType) {
            holderTypeMessageSent -> {
                ...
                MessageListAdapter.SentViewHolder(binding)
            }
            holderTypeMessageReceived -> {
                val binding = ListItemMessageReceivedBinding.inflate(layoutInflater, parent, false)
                MessageListAdapter.ReceivedViewHolder(binding)
            }
            else -> {
